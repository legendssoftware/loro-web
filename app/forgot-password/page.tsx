    ...
    return (
        <div
            ...
            <div className="w-full max-w-md p-6 sm:p-8 space-y-4 sm:space-y-6 bg-white/10 backdrop-blur-lg rounded-xl shadow-lg relative">
                ...
                <form onSubmit={handleSubmit(handleForgotPassword)} className="space-y-4 mt-4 sm:mt-6">
                    ...
                    <Button
                        ...
                        {isLoading ? (
                            <div className="flex items-center justify-center space-x-1">
                                <p className="text-white font-normal uppercase">Sending ... </p>
                                <Loader2 className="w-4 h-4 animate-spin mr-2" color="white" />
                            </div>
                        ) : (
