...
=======
                ...
                <Button variant="outline" className="w-full h-12 mt-4 text-xs uppercase transition-all group-hover:bg-primary group-hover:text-white">
                  Get Started
                </Button>
              </div>
            </motion.div>
