...
export const metadata: Metadata = {
  ...
  description: "Streamline your customer relationships with our powerful CRM platform. Features include contact management, sales pipeline tracking, and detailed analytics.",
  keywords: [
    "CRM",
