...
import { CheckSquare, FileText, HandCoins, UserPlusIcon, Users, Package } from 'lucide-react';
                ...
                <Tabs defaultValue='tasks' className='w-full'>
                    <TabsList className='justify-start w-full h-12 bg-background'>
                        ...
                        <TabsTrigger
                            ...
                            value='leads'
                        >
                            <UserPlusIcon size={16} strokeWidth={1.5} className='text-=card-foreground' />
                        ...
                        <TabsTrigger
                            ...
                            value='inventory'
                        >
                            <Package size={16} strokeWidth={1.5} className='text-=card-foreground' />
