...
const timezones = [
    ...
    { value: 'Asia/Tokyo', label: 'Japan Standard Time (JST) - Tokyo' },
    {
        ...
        label: 'Australian Eastern Standard Time (AEST) - Sydney',
    },
];
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormDescription className="text-[10px] uppercase text-muted-foreground">
                                            YOUR BUSINESS TIMEZONE AFFECTS HOW
                                        ...
                                        >
                                            ...
                                            <SelectContent>
                                                ...
                                                <SelectItem
                                                    ...
                                                    className="text-[10px] font-thin font-body"
                                                >
                                                    CUSTOM (DIFFERENT HOURS PER
                                                    DAY)
                                                </SelectItem>
                                            </SelectContent>
                                        </Select>
                                        <FormDescription className="text-[10px] uppercase text-muted-foreground">
                                            CHOOSE HOW TO CONFIGURE YOUR
                                            BUSINESS HOURS
                                        </FormDescription>
                                        <FormMessage className="text-xs" />
                                    </FormItem>
                                            ...
                                            {form.watch(
                                                ...
                                                <div className="grid grid-cols-2 gap-4">
                                                    <FormField
                                                        control={form.control}
                                                        name={
                                                            `customHours.${day}.openTime` as any
                                                        }
                                                        render={({ field }) => (
                                                            <FormItem>
                                                                <FormLabel className="text-xs font-thin uppercase font-body">
                                                    ...
                                                    <FormField
                                                        control={form.control}
                                                        name={
                                                            `customHours.${day}.closeTime` as any
                                                        }
                                                        render={({ field }) => (
                                                            <FormItem>
                                                                <FormLabel className="text-xs font-thin uppercase font-body">
                                                                        ...
                                                                        {timeOptions.map(
                                                                            (
                                                                                ...
                                                                                <SelectItem
                                                                                    ...
                                                                                    className="text-[10px] font-thin font-body uppercase"
                                                                                >
                                                                                    {
                                                                                        time.display
                                                                                    }
                        ...
                        <div className="space-y-4">
                            {form.watch('holidays').map((_, index) => (
                                ...
                                >
                                                ...
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Input
                                                            type="date"
                                                            {...field}
                                                            className="h-10 font-light bg-card border-border"
                                                        />
                                                    </FormControl>
                                                    <FormMessage className="text-xs" />
                                                </FormItem>
                                    ...
                                    {form.watch(
                                        `holidays.${index}.isOpen` as any,
                                    ) && (
                                        <div className="grid grid-cols-2 gap-4">
                                            <FormField
                                                control={form.control}
                                                name={
                                                    `holidays.${index}.openTime` as any
                                                }
                                                render={({ field }) => (
                                                    <FormItem>
                                                        <FormLabel className="text-xs font-thin uppercase font-body">
                                            ...
                                            <FormField
                                                control={form.control}
                                                name={
                                                    `holidays.${index}.closeTime` as any
                                                }
                                                render={({ field }) => (
                                                    <FormItem>
                                                        <FormLabel className="text-xs font-thin uppercase font-body">
