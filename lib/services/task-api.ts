...
import { Task, TaskFilterParams, PaginatedTasksResponse, TaskStatus } from '@/lib/types/task';

// Simplified TaskApi class that relies on axios interceptors for token handling
export class TaskApi {
    static async getTasks(filters: TaskFilterParams = {}): Promise<PaginatedTasksResponse> {
        try {
    ...
    static async updateTask(taskId: number, updates: Partial<Task>): Promise<void> {
        try {
            // The axios interceptor will add the token headers
