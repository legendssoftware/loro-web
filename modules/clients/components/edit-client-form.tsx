        ...
        return {
            ...
            communicationSchedules: clientData?.communicationSchedules && clientData.communicationSchedules.length > 0 
                ? clientData.communicationSchedules.map(schedule => ({
                    ...
                    frequency: schedule.frequency as CommunicationFrequency,
                    customFrequencyDays: schedule.customFrequencyDays,
                    preferredTime: schedule.preferredTime,
                    preferredDays: schedule.preferredDays,
                    nextScheduledDate: schedule.nextScheduledDate ? new Date(schedule.nextScheduledDate) : undefined,
                    isActive: schedule.isActive ?? true,
                    notes: schedule.notes,
                    assignedToUserId: schedule.assignedTo?.uid,
                    metadata: schedule.metadata,
                }))
                : [{ isActive: true }], // Default with one empty object with required isActive field
        };
    };
