...
interface LeadsTabGroupProps {
    tabs: Tab[];
    activeTab: string;
    onTabChange: (tabId: string) => void;
}

function LeadsTabGroupComponent({ tabs, activeTab, onTabChange }: LeadsTabGroupProps) {
...
export const LeadsTabGroup = memo(LeadsTabGroupComponent);
