...
const ClaimListComponent = ({
    ...
    const filteredClaims = useMemo(() => {
        return claims.filter(claim => {
            ...
            const matchesUser = userFilter === 'all' || claim.owner.uid.toString() === userFilter;
        ...
        return (
            <div className='space-y-4'>
                ...
                <div className='flex flex-col items-center justify-center w-full gap-2 h-96'>
                    ...
                    <p className='text-xs font-normal uppercase text-muted-foreground font-body'>No claims found</p>
                </div>
            </div>
        );
    }
