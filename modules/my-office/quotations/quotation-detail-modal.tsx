                        ...
                        <div className='grid grid-cols-2 gap-4'>
                            <div className='space-y-2'>
                                ...
                                <div className='text-xs font-normal font-body'>
                                    ...
                                    <div className='flex flex-row items-center gap-1'>
                                        ...
                                        <p>{selectedQuotation?.client?.alternativePhone || 'N/A'}</p>
                                    </div>
                                    <div className='flex flex-row items-center gap-1'>
                                        <p className='text-[10px] font-normal uppercase text-muted-foreground'>
                                            Address:
                            ...
                            <div className='space-y-2'>
                                ...
                                <div className='text-xs font-normal font-body'>
                                    ...
                                    <div className='flex flex-row items-center gap-1'>
                                        <p className='text-[10px] font-normal uppercase text-muted-foreground'>Date:</p>
                                        <p>
                                ...
                                <table className='w-full'>
                                    <thead>
                                        <tr className='border-b bg-muted/50'>
                                            <th className='px-4 py-2 text-[10px] font-normal uppercase tracking-wider text-left font-body'>
                                                Product
                                            </th>
                                            <th className='px-4 py-2 text-[10px] font-normal uppercase tracking-wider text-left font-body'>
                                                SKU/Reference
                                            </th>
                                            <th className='px-4 py-2 text-[10px] font-normal uppercase tracking-wider text-center font-body'>
                                                Quantity
                                            </th>
                                            <th className='px-4 py-2 text-[10px] font-normal uppercase tracking-wider text-right font-body'>
                                                Unit Price
                                            </th>
                                            <th className='px-4 py-2 text-[10px] font-normal uppercase tracking-wider text-right font-body'>
                                                Total
                                    ...
                                    <tbody className='divide-y'>
                                        ...
                                        <tr className='border-t bg-muted/50'>
                                            <td
                                                colSpan={4}
                                                className='py-2 px-4 text-[10px] font-normal uppercase tracking-wider text-right font-body'
                                            >
                                                Total Amount
                                            </td>
                            ...
                            <div className='space-y-2'>
                                ...
                                <div className='text-xs font-normal font-body'>
                                    <div className='flex flex-row items-center gap-1'>
                                        ...
                                        <p>{selectedQuotation?.shippingMethod || 'Not specified'}</p>
                                    </div>
                                    <div className='flex flex-row items-center gap-1'>
                                        <p className='text-[10px] font-normal uppercase text-muted-foreground'>
                                            Packaging:
                                        </p>
                                        <p>{selectedQuotation?.packagingRequirements || 'Standard packaging'}</p>
                                    </div>
                                    <div className='flex flex-row items-center gap-1'>
                                        <p className='text-[10px] font-normal uppercase text-muted-foreground'>
                                            Instructions:
                            ...
                            <div className='space-y-2'>
                                ...
                                <div className='text-xs font-normal font-body'>
                                    ...
                                    {selectedQuotation?.resellerCommission && (
                                        <div className='flex flex-row items-center gap-1'>
                                            <p className='text-[10px] font-normal uppercase text-muted-foreground'>
                                                Commission: R{Number(selectedQuotation.resellerCommission).toFixed(2)}
                                            </p>
                                        </div>
                                    )}
                                </div>
