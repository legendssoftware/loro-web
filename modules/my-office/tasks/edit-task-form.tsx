...
const EditTaskFormComponent = ({ task, onUpdate, onDelete, isUpdating, isDeleting }: EditTaskFormProps) => {
    return (
        <div>
                ...
                <div className='grid gap-6 py-4'>
                    <div className='space-y-2'>
                        ...
                        <div className='flex items-center justify-between'>
                            <div className='flex flex-col w-1/2 gap-1'>
                                <p className='text-[10px] font-body font-normal text-muted-foreground uppercase'>
                                    Name
                                </p>
                                <p className='text-xs font-normal font-body text-card-foreground'>
                                    {task?.clients?.[0]?.name}
                                </p>
                            </div>
                            <div className='flex flex-col w-1/2 gap-1'>
                        ...
                        <div className='flex items-center justify-between'>
                            <div className='flex flex-col w-1/2 gap-1'>
                                ...
                                <p className='text-xs font-normal font-body text-card-foreground'>
                                    {task?.clients?.[0]?.contactPerson}
                                </p>
                            </div>
                        </div>
                    </div>
                    <div className='space-y-2'>
                        <h3 className='text-xs font-normal uppercase font-body text-muted-foreground'>Task Details</h3>
                        <div className='flex items-center justify-between'>
                            <div className='flex flex-col w-1/2 gap-1'>
                                <p className='text-[10px] font-body font-normal text-muted-foreground uppercase'>
                                    Repetition
                    ...
                    <div className='space-y-2'>
                        ...
                        {task?.subtasks?.map((subTask: SubTask) => (
                            <div
                                key={subTask?.uid}
                                className='flex items-center justify-between px-3 py-4 border rounded cursor-pointer hover:bg-accent/40'
                            >
