        ...
        <form onSubmit={handleSubmit}>
            <ScrollArea className='h-[60vh] pr-4'>
                <div className='grid gap-4 py-2'>
                            ...
                            <Popover>
                                <PopoverTrigger asChild>
                                    <Button
                                        ...
                                        className={cn(
                                            'w-full justify-start text-left font-normal text-xs font-body shadow-none',
                                            !formData?.repetitionEndDate && 'text-muted-foreground',
                                        )}
                                    >
                                        <CalendarIcon className='w-4 h-4 mr-2' />
                    ...
                    <div className='grid grid-cols-2 gap-4'>
                        <div className='grid gap-1.5'>
                            ...
                            <Select
                                ...
                                onValueChange={value =>
                                    setFormData(prev => ({ ...prev, repetitionType: value as RepetitionType }))
                                }
                            >
                                <SelectTrigger className='text-xs font-body'>
                        ...
                        <div className='grid gap-1.5'>
                            ...
                            <Select
                                ...
                                onValueChange={value =>
                                    setFormData(prev => ({ ...prev, targetCategory: value as TargetCategory }))
                                }
                            >
                                <SelectTrigger className='text-xs font-body'>
                    ...
                    <div className='grid grid-cols-2 gap-4'>
                        <div className='grid gap-1.5'>
                            <UserSelect value={formData.assignees} onChange={handleAssigneesChange} />
                        </div>

                        <div className='grid gap-1.5'>
                            <ClientSelect value={formData.client} onChange={handleClientChange} />
                        </div>
                    </div>
                    <div className='grid gap-1.5'>
                        <Label
