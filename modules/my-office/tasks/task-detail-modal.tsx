                ...
                {isEditMode ? (
                    <ScrollArea className="h-[60vh] pr-4">
                        <div className="grid gap-4 py-2">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="grid gap-1.5">
                                    <Label htmlFor="repetitionType" className="text-xs font-normal uppercase font-body text-card-foreground">
                                        Repetition Type
                                    </Label>
                                    <Select
                                ...
                                <div className="grid gap-1.5">
                                    <Label htmlFor="status" className="text-xs font-normal uppercase font-body text-card-foreground">
                                        Status
                                    </Label>
                                    <Select
                            ...
                            <div className="grid gap-1.5">
                                <Label htmlFor="notes" className="text-xs font-normal uppercase font-body text-card-foreground">
                                    Notes
                                </Label>
                                <Textarea
                                    id="notes"
                            ...
                            <div className="grid gap-1.5">
                                <Label htmlFor="comment" className="text-xs font-normal uppercase font-body text-card-foreground">
                                    Comment
                                </Label>
                                <Textarea
                                    id="comment"
