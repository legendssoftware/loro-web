...
export function CustomReport({
    ...
    const handleGenerateReport = () => {
        // Simulate loading
        setTimeout(() => {
            // Add any additional logic you want to execute after report generation
        }, 1500);
    };
            ...
            <div className="flex items-center justify-between mb-4">
                <div>
                    ...
                    <p className="text-xs font-thin uppercase text-muted-foreground font-body">
                        Generate customized reports for your organization
                    </p>
                    <p className="text-xs italic font-thin text-primary/70 font-body">
                        More report types activating soon
                    </p>
                </div>
                <Button
                    variant="outline"
                            ...
                            <Card className="shadow-sm bg-card">
                                <CardContent className="p-6">
                                    <div className="flex flex-col space-y-2">
                                        ...
                                        <div className="flex items-end justify-between">
                                            <p className="text-3xl font-semibold uppercase font-body">{report?.metrics?.tasks?.flags?.closedFlags || 0}</p>
                                            <p className="text-xs font-normal uppercase text-muted-foreground font-body">
